...
define(["silk/visualisation", "silk/util", "silk/event", "webix"],
    function (vis, util, event) {
        ...
        my.TreeController = function (world, selectionModel, treeId) {
            var tree = $$(treeId);
            ...
            world.addListener(event.ANY_OBJECT, vis.WorldObject.EVENTS.CHILD_ADDED, childAdded);
            world.addListener(event.ANY_OBJECT, vis.WorldObject.EVENTS.CHILD_REMOVING, childRemoving);
